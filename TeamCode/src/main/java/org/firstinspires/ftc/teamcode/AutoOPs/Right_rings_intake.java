...
@Autonomous(name = "Right_rings_intake", group = "AutoOP")
public class Right_rings_intake extends Robot
{
    OpenCvCamera webcam;
    ...
    public void runOpMode()
    {
        ...
        waitForStart();
        {
            ...
            //goToPosition(25* COUNTS_PER_INCH,-455*COUNTS_PER_INCH,0.4*koeff,-45,3*COUNTS_PER_INCH);
            ...
            goToPosition(37* COUNTS_PER_INCH, -200*COUNTS_PER_INCH,0.5*koeff,0,15*COUNTS_PER_INCH);
            goToPosition(37* COUNTS_PER_INCH, -227*COUNTS_PER_INCH,0.2*koeff,9,2*COUNTS_PER_INCH);
            ...
            if(countOfRings==0&&check){//добавить координату
                check=false;
                goToPosition(37* COUNTS_PER_INCH,-180* COUNTS_PER_INCH,0.3*koeff,0,4*COUNTS_PER_INCH);

                while(timer.milliseconds() < 24000){

                };
                goToPosition(37* COUNTS_PER_INCH,-276* COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);
                ...
                goToPosition(48 * COUNTS_PER_INCH, -276 * COUNTS_PER_INCH, 0.2*koeff, 0,  1.5* COUNTS_PER_INCH);
            ...
            if(countOfRings==4&&check){//добавить координату
                ...
                goToPosition(37* COUNTS_PER_INCH, -125 * COUNTS_PER_INCH, 0.6 * koeff, 0, 11 * COUNTS_PER_INCH);
                ...
                goToPosition(25* COUNTS_PER_INCH,-455*COUNTS_PER_INCH,0.4*koeff,0,3*COUNTS_PER_INCH);
...
//                setMotorsPower(0,0,0,0);
                ...
                goToPosition(48 * COUNTS_PER_INCH, -300 * COUNTS_PER_INCH, 0.5*koeff, 0, 3 * COUNTS_PER_INCH);
            ...
            if(countOfRings==1&&check){//добавить координату
                ...
                goToPosition(37 * COUNTS_PER_INCH, -130 * COUNTS_PER_INCH, 0.5 * koeff, 0, 8 * COUNTS_PER_INCH);
                goToPosition(-45 * COUNTS_PER_INCH, -110 * COUNTS_PER_INCH, 0.3 * koeff, 0, 2 * COUNTS_PER_INCH);
                goToPosition(-45 * COUNTS_PER_INCH, -180 * COUNTS_PER_INCH, 0.2 * koeff, 0, 2 * COUNTS_PER_INCH);
                ...
                goToPosition(28* COUNTS_PER_INCH,-430*COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);
                ...
                setMotorsPower(0,0,0,0);
                goToPosition(48 * COUNTS_PER_INCH, -300 * COUNTS_PER_INCH, 0.2*koeff, 0, 3 * COUNTS_PER_INCH);
