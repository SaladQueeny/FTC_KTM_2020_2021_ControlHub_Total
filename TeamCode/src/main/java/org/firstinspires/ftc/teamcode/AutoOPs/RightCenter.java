...
@Autonomous(name = "RightCenter", group = "AutoOP")
public class RightCenter extends Robot
{
    OpenCvCamera webcam;
...
/*
            ...
            Shooting(koeff,0.67);
            goToPosition(-3* COUNTS_PER_INCH, -170*COUNTS_PER_INCH,0.5*koeff,0,7*COUNTS_PER_INCH);
            goToPosition(-3* COUNTS_PER_INCH, -227*COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);
            Shoot();

            angles=imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
            while(!isStopRequested()&&angles.firstAngle<4.5){
            ...
            while(!isStopRequested()&&angles.firstAngle<9){
                setMotorsPower(-0.15*koeff,-0.15*koeff,-0.15*koeff,-0.15*koeff);
                angles=imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
            }
            setMotorsPower(0,0,0,0);
...
*/
           ...
           /* Shooting(koeff,0.75);
            goToPosition(-18* COUNTS_PER_INCH, -150*COUNTS_PER_INCH,0.5*koeff,0,10*COUNTS_PER_INCH);
            goToPosition(-13* COUNTS_PER_INCH, -207*COUNTS_PER_INCH,0.18*koeff,-12,2*COUNTS_PER_INCH);
            ...
            if(countOfRings==4&&check) {
                ...
                goToPosition(-12* COUNTS_PER_INCH, -125 * COUNTS_PER_INCH, 0.6 * koeff, 0, 11 * COUNTS_PER_INCH);
                goToPosition(44 * COUNTS_PER_INCH, -103 * COUNTS_PER_INCH, 0.25 * koeff, 0, 2 * COUNTS_PER_INCH);
                ...
                setMotorsPower(-0.75,0.54,0.54,-0.75);
                sleep(250);
                m5Lift.setPower(-1);
                setMotorsPower(0,0,0,0);
                sleep(200);
                ...
                angles = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
                while (!isStopRequested() && angles.firstAngle > -3) {
                  setMotorsPower(0.1 * koeff, 0.15 * koeff, 0.1 * koeff, 0.15* koeff);
                    angles = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
                }
                setMotorsPower(0, 0, 0, 0);
                ...
                goToPosition(48* COUNTS_PER_INCH,-400*COUNTS_PER_INCH,0.7*koeff,0,20*COUNTS_PER_INCH);
                s3Rotation.setPosition(0);
                goToPosition(143* COUNTS_PER_INCH,-455*COUNTS_PER_INCH,0.3*koeff,0,3*COUNTS_PER_INCH);

                otpustivobl(koeff);

                goToPosition(30 * COUNTS_PER_INCH, -400 * COUNTS_PER_INCH, 0.7*koeff, 0, 18* COUNTS_PER_INCH);
                goToPosition(-30* COUNTS_PER_INCH, -305 * COUNTS_PER_INCH, 0.4*koeff, 0, 8* COUNTS_PER_INCH);
            ...
            if(countOfRings==1&&check){//добавить координат
                ...
                goToPosition(-16 * COUNTS_PER_INCH, -130 * COUNTS_PER_INCH, 0.5 * koeff, 0, 8 * COUNTS_PER_INCH);
                goToPosition(45 * COUNTS_PER_INCH, -110 * COUNTS_PER_INCH, 0.3 * koeff, 0, 2 * COUNTS_PER_INCH);
                goToPosition(45 * COUNTS_PER_INCH, -190 * COUNTS_PER_INCH, 0.2 * koeff, 0, 2 * COUNTS_PER_INCH);
                ...
                goToPosition(43* COUNTS_PER_INCH,-350*COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);
                s3Rotation.setPosition(0);
                otpustivobl(koeff);
            ...
            if(countOfRings==0&&check){//добавить координату
                ...
                Shooting(koeff,0.68);
                goToPosition(-32* COUNTS_PER_INCH, -190*COUNTS_PER_INCH,0.5*koeff,0,15*COUNTS_PER_INCH);
                goToPosition(-32* COUNTS_PER_INCH, -255*COUNTS_PER_INCH,0.15*koeff,8,1.5*COUNTS_PER_INCH);

                while(!isStopRequested()&&globalPositionUpdate.returnOrientation()>6){
                ...
                while(!isStopRequested()&&globalPositionUpdate.returnOrientation()>0){
                    m1Drive.setPower(0.15);
                    m2Drive.setPower(0.15);
                    m3Drive.setPower(0.15);
                    m4Drive.setPower(0.15);
                ...
                /*wobble*/
                goToPosition(80* COUNTS_PER_INCH,-275*COUNTS_PER_INCH,0.5*koeff,0,15*COUNTS_PER_INCH);
                goToPosition(147* COUNTS_PER_INCH,-275*COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);

                s3Rotation.setPosition(0);
                otpustivobl(koeff);

                goToPosition(80* COUNTS_PER_INCH,-260*COUNTS_PER_INCH,0.5*koeff,0,15*COUNTS_PER_INCH);
                ...
                goToPosition(29* COUNTS_PER_INCH, -207*COUNTS_PER_INCH,0.2*koeff,-5,2*COUNTS_PER_INCH);
                ...
                /*parkovka*/
                goToPosition(20* COUNTS_PER_INCH,-275*COUNTS_PER_INCH,0.4*koeff,0,10*COUNTS_PER_INCH);
                goToPosition(-30 * COUNTS_PER_INCH, -300 * COUNTS_PER_INCH, 0.3*koeff, 0, 3 * COUNTS_PER_INCH);
