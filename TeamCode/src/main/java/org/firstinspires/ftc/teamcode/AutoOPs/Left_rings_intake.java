...
@Autonomous(name = "Left_rings_intake", group = "AutoOP")
public class Left_rings_intake extends Robot
{
    OpenCvCamera webcam;
...
//
        ...
        waitForStart();
        {
            ...
            goToPosition(-49* COUNTS_PER_INCH, -195*COUNTS_PER_INCH,0.5*koeff,0,10*COUNTS_PER_INCH);
            goToPosition(-47* COUNTS_PER_INCH, -217*COUNTS_PER_INCH,0.2*koeff,-18,2*COUNTS_PER_INCH);
            ...
            if(countOfRings==4&&check){
                ...
                goToPosition(-52 * COUNTS_PER_INCH, -130 * COUNTS_PER_INCH, 0.6 * koeff, 0, 13 * COUNTS_PER_INCH);
                goToPosition(40 * COUNTS_PER_INCH, -103 * COUNTS_PER_INCH, 0.25 * koeff, 0, 2 * COUNTS_PER_INCH);
                ...
                goToPosition(-52* COUNTS_PER_INCH,-430*COUNTS_PER_INCH,0.6*koeff,0,10*COUNTS_PER_INCH);
                goToPosition(-52* COUNTS_PER_INCH,-455*COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);
                s3Rotation.setPosition(0);
                otpustivobl(koeff);
                goToPosition(-52 * COUNTS_PER_INCH, -350 * COUNTS_PER_INCH, 0.6*koeff, 0, 10 * COUNTS_PER_INCH);
                goToPosition(-52 * COUNTS_PER_INCH, -310 * COUNTS_PER_INCH, 0.3*koeff, 0, 4 * COUNTS_PER_INCH);
            ...
            if(countOfRings==1&&check){
                ...
                m5Lift.setPower(-1);
                goToPosition(40 * COUNTS_PER_INCH, -103 * COUNTS_PER_INCH, 0.25 * koeff, 0, 2 * COUNTS_PER_INCH);
                goToPosition(40 * COUNTS_PER_INCH, -180 * COUNTS_PER_INCH, 0.25 * koeff, 0, 2 * COUNTS_PER_INCH);
                ...
                goToPosition(-52 * COUNTS_PER_INCH, -330 * COUNTS_PER_INCH, 0.4*koeff, 0, 5 * COUNTS_PER_INCH);
