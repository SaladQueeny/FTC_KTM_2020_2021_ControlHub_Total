...
public class Right extends Robot
{
    ...
    public void runOpMode()
    {
        ...
        waitForStart();
        {
            ...
            goToPosition(37* COUNTS_PER_INCH, -200*COUNTS_PER_INCH,0.4*koeff,0,10*COUNTS_PER_INCH);
            goToPosition(37* COUNTS_PER_INCH, -227*COUNTS_PER_INCH,0.18*koeff,9,2*COUNTS_PER_INCH);
            ...
            if(countOfRings==4&&check){//добавить координату
                check=false;
                goToPosition(37* COUNTS_PER_INCH,-455*COUNTS_PER_INCH,0.3*koeff,0,3*COUNTS_PER_INCH);
                ...
                goToPosition(48 * COUNTS_PER_INCH, -300 * COUNTS_PER_INCH, 0.3*koeff, 0, 3 * COUNTS_PER_INCH);
